      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Control Panel</h1>
          </div>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body text-dark h6">
              <div class="row">
              <div class="col-lg-8">
            <form action="partial/cpanel.php" method="POST" enctype="multipart/form-data">
              <div class="row align-items-center">
                <div class="col col-lg-3">Judul Web</div>
                <input type="text" name="nama" value="<?php echo $cpn['nama']; ?>" class = "form-control col col-lg-9">
              </div>
              <hr>
              <div class="row align-items-center">
